...
SOLVERS_CONFIG = {
    ...
    'maxcut': {
        'name': 'MaxCut',
        'class': lambda: solver.MaxCutSolver(),
        'enabled': True
    },
    'greedy': {
        'name': 'Vanilla Greedy',
        'class': lambda: solver.VanillaGreedySolver(),
        'enabled': True
    },
    'vanilla': {
    ...
    'spectral': {
        'name': 'Spectral',
        'class': lambda: solver.SpectralSolver(),
        'enabled': True
    },
    'maxcut_greedy': {
        'name': 'MaxCut Greedy',
        'class': lambda: solver.MaxCutGreedySolver(),
        'enabled': True
    },
    'spectral_greedy': {
        'name': 'Spectral Greedy',
        'class': lambda: solver.SpectralGreedySolver(),
        'enabled': True
    },
    'smj': {
        'name': 'Shared Mutation Joining',
        'class': lambda: solver.SharedMutationJoiningSolver(),
        'enabled': True
    },
    'dmj': {
        'name': 'Distance',
        'class': lambda: solver.DistanceSolver(),
        'enabled': True
    },
    'ilp': {
        'name': 'ILP',
        'class': lambda: solver.ILPSolver(),
